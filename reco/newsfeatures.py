...
feedlist = ['http://today.reuters.com/rss/topNews',
            ...
            'http://blogs.abcnews.com/thenote/index.rdf',
            'http://feeds.feedburner.com/hotair/main',
            'http://feeds.dailykos.com/dailykos/index.xml',
            'http://newsbusters.org/node/feed',
            'http://blogs.abcnews.com/politicalpunch/index.rdf',
            'http://feeds.latimes.com/topoftheticket',
...
def cleantitles(delrows, artt):
    # delrows - a list of rows from the word matrix
    # where the entries are all zeros
    # artt - the list of article titles
    # remove the articles that have all zeros from the 
    # list of articles
    cleant = []    
    for i in range(len(artt)):
        if not i in delrows:
            cleant.append(artt[i])
    return cleant
